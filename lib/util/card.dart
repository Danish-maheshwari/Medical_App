...
import 'package:medical_app_ui/screen/profile.dart';
          ...
          children: [
            Expanded(
              child: Column(
                children: [
                  _buildCartItem(
                      'Sugar free gold', 'bottle of 500 pellets', 25, q1,
                      (val) {
                    setState(() {
                      q1 = val;
                    });
                  ...
                  _buildCartItem(
                      'Sugar free gold', 'bottle of 500 pellets', 18, q2,
                      (val) {
                    setState(() {
                      q2 = val;
                    });
                ...
                child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (Center) => Profile()));
                    },
                    child: Text(
                      "Place Order",
